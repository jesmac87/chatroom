...
app.controller('MainController', function($scope, parseService, $interval) {
    ...
    //correlates to on the input box), pass that text to the postData method on the parseService object which 
    //will then post it to the parse backend.
    ...
    //immediately call the funciton so there is no delay when loading the page
    $scope.getParseData();
